...
class Chat {
  public:
    crow::response send_message_to_room(const mongo_connection::Mongo &mongo, // nowrap
    ...
    crow::response get_all_rooms_for_user(const mongo_connection::Mongo &mongo, // nowrap
